namespace API.Errors
{
    ...
    public class RespuestaApi
    {
        ...
        public int CodigoEstado { get; set; } // Código de error
        ...
        public RespuestaApi(int codigoEstado, string mensaje = null)
        {
            CodigoEstado = codigoEstado;  // Asignar el código de estado
            Mensaje = mensaje ?? ObtenerMensajePredeterminadoParaCodigoEstado(codigoEstado);  // Usar el mensaje predeterminado si no se proporciona uno
        }
        ...
        private string ObtenerMensajePredeterminadoParaCodigoEstado(int codigoEstado)
        {
